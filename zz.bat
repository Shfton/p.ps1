# Zeta Ultimate Locker v4 — чистый PowerShell (без cmd-костылей)
# ------------------------------------------------------------
# Проверка прав
...
# ------------------------------------------------------------
# 2. Жёсткая блокировка клавиатуры (работает 100%)
try {
    # Метод 1: через реестр (гарантированно)
...
# ------------------------------------------------------------
# 3. Полноэкранная форма с циферблатом
